...
[![Go](https://github.com/Holyson/test-go-zero-cors/workflows/Go/badge.svg?branch=master)](https://github.com/Holyson/test-go-zero-cors/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/Holyson/test-go-zero-cors)](https://goreportcard.com/report/github.com/Holyson/test-go-zero-cors)
...
[![Release](https://img.shields.io/github/v/release/zeromicro/go-zero.svg?style=flat-square)](https://github.com/Holyson/test-go-zero-cors)
[![Go Reference](https://pkg.go.dev/badge/github.com/Holyson/test-go-zero-cors.svg)](https://pkg.go.dev/github.com/Holyson/test-go-zero-cors)
...
> 
> `GOPROXY=https://goproxy.cn/,direct go install github.com/Holyson/test-go-zero-cors/tools/goctl@latest`
> 
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/Holyson/test-go-zero-cors
```
...
1. 安装 goctl 工具
    ...
    ```shell
    # Go 1.15 及之前版本
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/Holyson/test-go-zero-cors/tools/goctl@latest
...
如果贵公司也已使用 go-zero，欢迎在 [登记地址](https://github.com/Holyson/test-go-zero-cors/issues/602) 登记，仅仅为了推广，不做其它用途。
