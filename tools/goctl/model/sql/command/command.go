...
import (
	...
	"github.com/Holyson/test-go-zero-cors/core/stores/postgres"
	"github.com/Holyson/test-go-zero-cors/core/stores/sqlx"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/config"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/model/sql/command/migrationnotes"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/model/sql/gen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/model/sql/model"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/model/sql/util"
	file "github.com/Holyson/test-go-zero-cors/tools/goctl/util"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/util/console"
