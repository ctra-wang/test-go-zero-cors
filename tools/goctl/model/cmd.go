...
import (
	"github.com/Holyson/test-go-zero-cors/tools/goctl/model/mongo"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/model/sql/command"
...
func init() {
	...
	ddlCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/Holyson/test-go-zero-cors/tree/master/tools/goctl/config/readme.md]")
	...
	datasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/Holyson/test-go-zero-cors/tree/master/tools/goctl/config/readme.md]")
	...
	pgDatasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/Holyson/test-go-zero-cors/tree/master/tools/goctl/config/readme.md]")
	...
	mongoCmd.Flags().StringVar(&mongo.VarStringStyle, "style", "", "The file naming format, see [https://github.com/Holyson/test-go-zero-cors/tree/master/tools/goctl/config/readme.md]")
