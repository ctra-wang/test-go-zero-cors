...
import (
	...
	"github.com/Holyson/test-go-zero-cors/tools/goctl/util/ctx"
)
...
const (
	...
	replacementBuilderx = "github.com/Holyson/test-go-zero-cors/core/stores/builder"
	goZeroMod           = "github.com/Holyson/test-go-zero-cors"
)
