...
import (
	...
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/bug"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/docker"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/env"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/internal/version"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/kube"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/migrate"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/model"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/quickstart"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/rpc"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/tpl"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/upgrade"
...
var (
	...
	rootCmd = &cobra.Command{
		...
		Long: "A cli tool to generate api, zrpc, model code\n\n" +
			"GitHub: https://github.com/Holyson/test-go-zero-cors\n" +
