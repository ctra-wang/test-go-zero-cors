...
import (
	...
	"github.com/Holyson/test-go-zero-cors/tools/goctl/pkg/downloader"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/pkg/goctl"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/rpc/execx"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/util/env"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/util/zipx"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/vars"
)
