...
import (
	...
	"github.com/Holyson/test-go-zero-cors/tools/goctl/example/rpc/hi/internal/config"
	eventServer "github.com/Holyson/test-go-zero-cors/tools/goctl/example/rpc/hi/internal/server/event"
	greetServer "github.com/Holyson/test-go-zero-cors/tools/goctl/example/rpc/hi/internal/server/greet"
