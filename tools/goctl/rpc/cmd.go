...
import (
	"github.com/Holyson/test-go-zero-cors/tools/goctl/rpc/cli"
...
func init() {
	...
	newCmd.Flags().StringVar(&cli.VarStringStyle, "style", "gozero", "The file "+
		"naming format, see [https://github.com/Holyson/test-go-zero-cors/tree/master/tools/goctl/config/readme.md]")
