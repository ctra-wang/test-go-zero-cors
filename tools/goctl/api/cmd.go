...
import (
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/apigen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/dartgen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/docgen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/format"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/gogen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/javagen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/ktgen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/new"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/tsgen"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/validate"
...
func init() {
	...
	Cmd.Flags().StringVar(&apigen.VarStringRemote, "remote", "", "The remote git repo of the"+
		...
		" https://github.com/Holyson/test-go-zero-cors-template directory structure")
	...
	goCmd.Flags().StringVar(&gogen.VarStringStyle, "style", "gozero", "The file naming format,"+
		" see [https://github.com/Holyson/test-go-zero-cors/blob/master/tools/goctl/config/readme.md]")
	...
	pluginCmd.Flags().StringVar(&plugin.VarStringStyle, "style", "",
		"The file naming format, see [https://github.com/Holyson/test-go-zero-cors/tree/master/tools/goctl/config/readme.md]")
