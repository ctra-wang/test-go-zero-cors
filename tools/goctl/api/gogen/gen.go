...
import (
	...
	apiformat "github.com/Holyson/test-go-zero-cors/tools/goctl/api/format"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/api/parser"
	apiutil "github.com/Holyson/test-go-zero-cors/tools/goctl/api/util"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/config"
	"github.com/Holyson/test-go-zero-cors/tools/goctl/pkg/golang"
