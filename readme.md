...
> 
> `go install github.com/Holyson/test-go-zero-cors/tools/goctl@latest`
> 
...
```shell
go get -u github.com/Holyson/test-go-zero-cors
```
...
1. install goctl
   ...
   GO111MODULE=on go get -u github.com/Holyson/test-go-zero-cors/tools/goctl@latest
